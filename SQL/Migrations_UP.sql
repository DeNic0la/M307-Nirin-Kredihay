...
CREATE USER 'Code'@'localhost' IDENTIFIED BY 'DevPassword';
GRANT USAGE ON *.* TO `Code`@`localhost`;
GRANT SELECT, INSERT, UPDATE ON `nirinkredihay`.* TO 'Code'@'localhost'; /* Only Those Permissions are needed for the Code*/
